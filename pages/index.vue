<template>
  <section class="container">
	<div>
	    ...
	    <div class="links">
	        <nuxt-link class="navbar-item" v-if="$i18n.locale != 'fr'" to="/fr">Français</nuxt-link>
	        <nuxt-link class="navbar-item" v-if="$i18n.locale != 'en'" to="/en">English</nuxt-link>
	        <nuxt-link class="navbar-item" v-if="$i18n.locale != 'ru'" to="/ru">Русский</nuxt-link>
	    </div>
      ...
      <v-container fluid grid-list-xl>
        ...
        <v-layout row wrap>
        <span v-for="rate in $store.state.rates" v-bind:key="rate" >
          <v-flex xs12 sm4 md4>
          <v-checkbox 
